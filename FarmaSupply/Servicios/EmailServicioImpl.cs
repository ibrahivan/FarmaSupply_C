...
{
    public class EmailServicioImpl:IServicioEmail
    {
        ...
        void IServicioEmail.enviarEmailRecuperacion(string emailDestino, string nombreUsuario, string token)
        {
            try
            {
                ...
                MailMessage mensajeDelCorreo = new MailMessage(EmailOrigen, emailDestino, "RESTABLECER CONTRASEÑA FARMASUPPLY", htmlContent);
