        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_usuario_propietario = table.Column<long>(type: "bigint", maxLength: 70, nullable: true),
                    IdUsuarioPropietarioNavigationIdUsuario = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tiendas", x => x.id_tienda);
                    table.ForeignKey(
                        name: "FK_tiendas_usuarios_IdUsuarioPropietarioNavigationIdUsuario",
                        column: x => x.IdUsuarioPropietarioNavigationIdUsuario,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tiendas_IdUsuarioPropietarioNavigationIdUsuario",
                schema: "fs_logica",
                table: "tiendas",
                column: "IdUsuarioPropietarioNavigationIdUsuario");
        }
